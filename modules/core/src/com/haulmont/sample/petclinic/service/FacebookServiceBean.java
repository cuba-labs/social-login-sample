...
public class FacebookServiceBean implements FacebookService {
    ...
    private static final String FB_ACCESS_TOKEN_PATH = "https://graph.facebook.com/v3.3/oauth/access_token?";
    ...
    public String getLoginUrl(String appUrl, OAuth2ResponseType responseType) {
        ...
        String authUrl = "http://www.facebook.com/v3.3/dialog/oauth";
    ...
    public FacebookUserData getUserData(String appUrl, String code) {
        ...
        String email = Strings.nullToEmpty(jsonObject.get("email").getAsString()
                .replace("\u0040", "@"));
    ...
    private String getUserDataAsJson(String accessToken) {
        ...
        String format = "json";
        String url = "https://graph.facebook.com/v3.3/me?access_token=" + accessToken +
                "&fields=" + fields +
                "&format=" + format;
